...
# --- CÀRREGA DE DADES ---
file_path = "SET_excel_app.xlsx"
df_raw = None
if os.path.exists(file_path):
    df_raw = pd.read_excel(file_path)
else:
    uploaded_file = st.file_uploader("📂 Puja l'Excel", type=["xlsx"])
    if uploaded_file: df_raw = pd.read_excel(uploaded_file)
...
if df_raw is not None:
    ...
    st.info("👋 Puja el fitxer Excel per carregar les rutes.")
